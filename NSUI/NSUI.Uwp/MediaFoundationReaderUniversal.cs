...
namespace NSUI
{
    ...
    internal class MediaFoundationReaderUniversal : MediaFoundationReader
    {
        private readonly MediaFoundationReaderUniversalSettings _settings;
